...
class Router:
    ...
    def build_forwarding_table(self, routes):
        ...
        for cidr, link in routes:
            table.append((get_network_prefix(cidr), link))
...
r = Router(routes)
print(r.route_packet("223.1.1.100"))
print(r.route_packet("223.1.2.5"))
print(r.route_packet("223.1.250.1"))
print(r.route_packet("198.51.100.1"))
